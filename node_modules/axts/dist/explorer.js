...
export async function explorer() {
    console.log(`\x1b[36m> \x1b[46m \x1b[37m\x1b[1mSWC \x1b[0m \x1b[36mRunning...\x1b[0m`);
    let totalFiles = 0;
    ...
    console.log(`Successfully compiled: ${totalFiles} files with swc (${time.ms(end - start)})`);
    return launch();
}
